...
hurl invoke oil oil_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- oil org1
# Install to your blockchain - From the root of your project
hurl install oil node -P ./chaincode-oil
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install oil node -P ./chaincode-oil --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade oil node 1.2 -P ./chaincode-oil
```
